...
{
    public class tbl_plan_m
    {
        [Key]
        public int id { get; set; }
        [StringLength(50)]
        public string vc_plan_code { get; set; }
        [StringLength(500)]
        public string vc_plan_desc { get; set; }
        public decimal nu_plan_min_amt { get; set; } = 0;
        public decimal nu_plan_max_amt { get; set; } = 0;
